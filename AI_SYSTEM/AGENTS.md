...
- Read README.md → AGENTS.md → ROADMAP_STATE.md → Active Spec
- Summarize your understanding before proposing changes
- If something is unclear, ask. Do not assume

Note:

ROADMAP_STATE.md provides system context (phases, gaps, risks).  
...
SESSION END  
- Update ROADMAP_STATE.md if phase status, risks, or priorities changed  
